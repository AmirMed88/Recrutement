...
import com.recrute.backend.Services.AttachmentService;
import com.recrute.backend.models.Attachment;
import com.recrute.backend.models.ResponseData;
...
public class AttachmentController {
    ...
    @PostMapping("/upload")
    public ResponseData uploadFile(@RequestParam("file") MultipartFile file,@RequestParam("id") Long id) throws Exception{
        ...
        return new ResponseData(attachment.getFileName(),downloadURL,file.getContentType(),file.getSize(),attachment.getProfilec());
    }
